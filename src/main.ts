...
const stickers: (Stickers | string)[] = [Stickers.Heart, Stickers.Star, Stickers.Smile];
...
function createButton(text: string, onClick: () => void, tooltip: string): HTMLButtonElement {
...
const thinButton = createButton("Thin Brush", () => {
...
const thickButton = createButton("Thick Brush", () => {
...
const redButton = createButton("Red Brush", () => {
...
const blueButton = createButton("Blue Brush", () => {
...
const _customStickerButton = createButton("Custom Emoji", () => {
...
const _markerButton = createButton("Marker", () => {
    currentColor = getRandomColor();
    toolPreview.style.backgroundColor = currentColor;
}, "Use a random color marker");

const _stickerButton = createButton("Sticker", () => {
...
const _exportButton = createButton("Export Canvas", () => {
...
modalText.textContent = "Welcome to Jason's App! Here are the available tools:\n\n" +
